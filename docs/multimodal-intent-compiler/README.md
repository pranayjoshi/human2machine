...
4. [Device connection and manual integration](03_DEVICE_CONNECTION.md)
5. [Neurosity Crown adapter](adapters/01_NEUROSITY_CROWN_ADAPTER.md)
6. [OpenBCI Ganglion EMG adapter](adapters/02_OPENBCI_GANGLION_EMG_ADAPTER.md)
7. [Audio adapter](adapters/03_AUDIO_ADAPTER.md)
8. [Vision adapter](adapters/04_VISION_ADAPTER.md)
9. [Robot simulator adapter](adapters/05_ROBOT_SIMULATOR_ADAPTER.md)
10. [Event hub and synchronization runtime](runtime/01_EVENT_HUB_AND_SYNCHRONIZATION.md)
11. [Intent fusion runtime](runtime/02_INTENT_FUSION_RUNTIME.md)
12. [Safety gateway](runtime/03_SAFETY_GATEWAY.md)
13. [Session storage and replay](runtime/04_SESSION_STORAGE_AND_REPLAY.md)
14. [Developer console UI](ui/01_DEVELOPER_CONSOLE.md)
15. [Testing and evaluation](testing/01_TESTING_AND_EVALUATION.md)
16. [SO-ARM101 integration](roadmap/01_SO_ARM101_INTEGRATION.md)
